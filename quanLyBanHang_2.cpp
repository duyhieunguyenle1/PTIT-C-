...
public:
    ...
    {
        os << a.mhd << ' ' << KH[a.mkh].tenKH << ' ' << KH[a.mkh].add << ' ' << MH[a.mmh].tenMH << ' ' << a.sl << ' ' << MH[a.mmh].giaBan * a.sl << " " 
		<<(MH[a.mmh].giaBan * a.sl)-(MH[a.mmh].giaMua * a.sl)<< endl;
        return os;
    }
};

bool cmp(HoaDon a,HoaDon b){
	if((MH[a.mmh].giaBan * a.sl)-(MH[a.mmh].giaMua * a.sl)!=(MH[b.mmh].giaBan * b.sl)-(MH[b.mmh].giaMua * b.sl))
	return (MH[a.mmh].giaBan * a.sl)-(MH[a.mmh].giaMua * a.sl)>(MH[b.mmh].giaBan * b.sl)-(MH[b.mmh].giaMua * b.sl);
	return a.mhd<b.mhd;
}
